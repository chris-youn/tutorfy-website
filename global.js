...
function updateCart() {
    ...
    if (sessionStorage.getItem("tutorSessionLong")) {
        ...
        listItemLongText.innerHTML = "Tutor Session(s) QTY: " + sessionStorage.getItem("tutorSessionLong") + " Price: $" + sessionStorage.getItem("tutorSessionLong") * 70;
    } else {
    ...
    if (sessionStorage.getItem("tutorSessionShortBulk")) {
        ...
        listItemShortBulkText.innerHTML = "Tutor Session(s) QTY: " + sessionStorage.getItem("tutorSessionShortBulk") + " Price: $" + sessionStorage.getItem("tutorSessionShortBulk") * 170;
    } else {
        listItemShortBulk.style.display = "none";
    }
    if (sessionStorage.getItem("tutorSessionLongBulk")) {
        listItemLongBulk.style.display = "flex";
        listItemLongBulkText.innerHTML = "Tutor Session(s) QTY: " + sessionStorage.getItem("tutorSessionLongBulk") + " Price: $" + sessionStorage.getItem("tutorSessionLongBulk") * 300;
    } else {
