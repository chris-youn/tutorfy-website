document.addEventListener('DOMContentLoaded', function() {
        ...
        const tutorButtonLong = document.getElementById('tutorButtonLong');
        const tutorButtonShortBulk = document.getElementById('tutorButtonShortBulk');
        const tutorButtonLongBulk = document.getElementById('tutorButtonLongBulk');
        tutorButtonShort.addEventListener('click', function() {
            addToCart("tutorSessionShort", 1);
        })
        tutorButtonLong.addEventListener('click', function(){
            addToCart("tutorSessionLong", 1);
        })
        tutorButtonShortBulk.addEventListener('click', function(){
            addToCart("tutorSessionShortBulk", 1);

        })
        tutorButtonLongBulk.addEventListener('click', function(){
